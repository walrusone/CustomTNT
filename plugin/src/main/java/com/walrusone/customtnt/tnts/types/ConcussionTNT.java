...
public class ConcussionTNT extends ExplosionType {
	...
	public ConcussionTNT(String name, String lore, int radius, int fuse, int duration, String particle, boolean throwable, boolean punchable, List<String> potions) {
		this.name = name;
		...
		customTnt = CustomTNT.getNMS().setTntType(customTnt,"Concussion");
	}
