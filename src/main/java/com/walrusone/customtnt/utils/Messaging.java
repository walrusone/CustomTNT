...
public final class Messaging {
    ...
    public static class MessageFormatter {
        ...
        public String format(String message) {
            ...
            if (CustomTNT.getMessaging().getMessage(message) != null) {
                message = CustomTNT.getMessaging().getMessage(message);
            }
            ...
            if (prefix) {
                message = CustomTNT.getMessaging().getPrefix() + message;
            }
	...
	private void copyDefaults(File playerFile) {
		...
		Reader defConfigStream = new InputStreamReader(CustomTNT.get().getResource("messages.yml"));
