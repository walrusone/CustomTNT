    ...
    public TimebombMenu(final Player player, final Location location) {
        ...
        CustomTNT.getIC().create(player, menuName, menuSlotsPerRow, event -> {
            ...
            CustomTNT.getIC().setOption(
                    player,
                    0,
                    new ItemStack(Material.CLOCK, CustomTNT.get().getConfig().getInt("tntTypes.timebomb.option1")),
            ...
            CustomTNT.getIC().setOption(
                    player,
                    2,
                    new ItemStack(Material.CLOCK, CustomTNT.get().getConfig().getInt("tntTypes.timebomb.option2")),
            ...
            CustomTNT.getIC().setOption(
                    player,
                    4,
                    new ItemStack(Material.CLOCK, CustomTNT.get().getConfig().getInt("tntTypes.timebomb.option3")),
            ...
            CustomTNT.getIC().setOption(
                    player,
                    6,
                    new ItemStack(Material.CLOCK, CustomTNT.get().getConfig().getInt("tntTypes.timebomb.option4")),
            ...
            CustomTNT.getIC().setOption(
                    player,
                    8,
                    new ItemStack(Material.CLOCK, CustomTNT.get().getConfig().getInt("tntTypes.timebomb.option5")),
